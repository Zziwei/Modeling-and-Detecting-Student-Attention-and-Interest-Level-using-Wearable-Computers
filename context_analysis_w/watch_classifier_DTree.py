...
# d
last_score = [0.9349816850]
last_list = [[28, 37, 47, 51, 80]]
s_mean = 0.9349816850

# # i
# last_score = [0.985347985348]
# last_list = [[25, 49, 80, 98, 105]]
# s_mean = 0.985347985348
    ...
    for current_combine_feature in combine_list:
        ...
        if len(parents_list) != 0:
            ...
            for tmp_parent in parents_list:
                if tmp_parent.score - 0.008 > s or s < s_mean - 0.008:
            ...
            if is_current_combine_feature_good:
                ...
                s_n += 1
                if s >= highest_score_in_iteration - 0.008:
